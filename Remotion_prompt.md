---
  ...
  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  【手順2】音声抽出 → Whisper word-level 取得
  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  主な変更点：
  - フォントサイズ: 54px → 68px
  - 白文字フチ: 黒2.5px → 赤(#FF0000) 5px
  - キーワード色: #FFD700 → #FFFF00
  - キーワードフチ: 黒(#000000) 5px
  - Caption型に timestampMs と confidence: 1 を必須化
  - 最初のテロップ(startFrame===0)のアニメーションスキップを明記